...
import com.cts.dto.response.RegisterCustomerResponseDTO;
...
import com.cts.service.impl.UserInfoConfigManager;
...
public class AuthServiceImplTest {
    ...
    @BeforeEach
    void setUp() {
        authService = new AuthServiceImpl(userRepo, cusRepo, dpRepo,
